...
export const BalanceBar = () => {
  return(
    ...
    <div className='flex flex-col justify-between w-9/12 h-40 mx-10 md:h-56 md:w-3/5 md:mx-40 bg-gradient-to-br from-blue-950 to-cyan-300 rounded-3xl'>
...
function TopUp(){ 
  return(
    <div className='fixed bottom-0 flex flex-col items-center w-11/12 gap-5 mx-auto bg-white shadow-inner h-5/12 top-1/3 rounded-t-2xl bg-opacity-10 backdrop-blur-lg drop-shadow-lg md:top-1/2'>
...
export function History(){
  return(
    <div className='relative flex flex-col items-center w-10/12 gap-5 mx-auto overflow-y-auto bg-white shadow-inner rounded-t-2xl bg-opacity-10 backdrop-blur-lg drop-shadow-lg md:top-1/3 h-fit'>
     <div className='sticky top-0 flex justify-start w-full gap-10 px-10 py-3 bg-white shadow-inner md:py-5 rounded-t-2xl bg-opacity-10 backdrop-blur-lg drop-shadow-lg '>
      ...
      <div className='flex flex-col w-10/12 gap-3 h-fit '>
        <div className='flex-none w-10/12 h-10 bg-gray-200 rounded-full md:w-7/12'></div>
        <div className='flex-none w-10/12 h-10 bg-gray-200 rounded-full md:w-7/12'></div>
        <div className='flex-none w-10/12 h-10 bg-gray-200 rounded-full md:w-7/12'></div>
        <div className='flex-none w-10/12 h-10 bg-gray-200 rounded-full md:w-7/12'></div>
        <div className='flex-none w-10/12 h-10 bg-gray-200 rounded-full md:w-7/12'></div>
