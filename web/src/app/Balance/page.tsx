...
const Home = () => {
  return (
    <div className='w-screen h-screen text-white -mt-6 z-0 flex justify-center'>
        <UniNavbar></UniNavbar>
        <div className='mt-40 w-screen flex justify-center  '>
            <div className='mx-10 md:mx-40 flex  bg-gradient-to-br from-blue-950 to-cyan-300 h-56 w-2/5 rounded-3xl flex-col justify-between'>
                <div className='flex flex-col px-5 py-5'>
                    <h1 className='text-2xl'>My Balance</h1>
                    <p className='text-5xl font-semibold'>Rp. 500.000</p>
                </div>
                <ul className='flex justify-between px-10 py-5'>

                    <li className='flex flex-col items-center jusify-center'>
